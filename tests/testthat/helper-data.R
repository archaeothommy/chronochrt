...
test_arranged_reference <- tibble::tibble(
  ...
  level = c(1, 2, 1, 2, 2, 2, 2, 2, 1, 1, 3, 3),
  add = c(FALSE, FALSE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE))
test_arranged_reference$region <- factor(tibble::tibble(
  region = "Atlantis",
  name = c("Atlas", "II", "Poseidon", "I", "a", "b", "c", "d", "Zeus", "Thanos", "a1", "a2"),
  start = c("-2500/-2000", -750, -1500, -1500, -400, -350, -150, 100, -200, -400, -1500, -1000),
  end = c(-1500, -200, -200, -750, -350, -250, 100, 300, 500, 300, -1000, -750),
  level = c(1, 2, 1, 2, 2, 2, 2, 2, 1, 1, 3, 3),
  add = c(FALSE, FALSE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, FALSE))$region, levels = c("Atlantis"))

test_plot_reference <- tibble::tibble(
  region = "Atlantis",
  name = c("Atlas", "II", "Poseidon", "I", "a", "b", "c", "d", "Zeus", "Thanos", "a1", "a2"),
  start = c("-2500/-2000", -750, -1500, -1500, -400, -350, -150, 100, -200, -400, -1500, -1000),
  end = c(-1500, -200, -200, -750, -350, -250, 100, 300, 500, 300, -1000, -750),
...
test <- tibble::tibble(Area = "Atlantis",
...
test_err2_Format <- tibble::tibble(Area = "Atlantis",
                                Title = c("Atlas", "II", "Poseidon", "I", "a", "b", "c", "d", "Zeus", "Thanos", "a1", "a2"),
                                Begin = c("-2500/-2000", -750, -1500, -1500, -400, -350, -150, 100, -200, -400, -1500, -1000),
                                End = c(-1500, -200, -200, -750, -350, -250, 100, 300, 500, 300, -1000, -750),
                                Subunit = c(1, 2, 1, 2, 2, 2, 2, 2, 1, 1, 3, 3),
...
test_err3_Level <- tibble::tibble(Area = "Atlantis",
                               Title = c("Atlas", "II", "Poseidon", "I", "a", "b", "c", "d", "Zeus", "Thanos", "a1", "a2"),
                               Begin = c("-2500/-2000", -750, -1500, -1500, -400, -350, -150, 100, -200, -400, -1500, -1000),
                               End = c(-1500, -200, -200, -750, -350, -250, 100, 300, 500, 300, -1000, -750),
...
test_labels_err1 <- tibble::tibble(
  region = c("Atlantis", "Sargassosee"),
  year = c(-1650, 250),
  position = c(1, "0.99"),
  label = c("Krieg mit Ägypten ", "Geburt von Aquaman"))

test_labels_err2 <- tibble::tibble(
  region = c("Atlantis", "Sargassosee"),
  year = c("-1650", 250),
  position = c(1, 0.99),
  label = c("Krieg mit Ägypten ", "Geburt von Aquaman"))
...
test_arranged_err <- tibble::tibble(
  Area = "Atlantis",
  name = c("Atlas", "II", "Poseidon", "I", "a", "b", "c", "d", "Zeus", "Thanos", "a1", "a2"),
  start = c("-2500/-2000", -750, -1500, -1500, -400, -350, -150, 100, -200, -400, -1500, -1000),
  end = c(-1500, -200, -200, -750, -350, -250, 100, 300, 500, 300, -1000, -750),
...
test_plot_err_format <- tibble::tibble(region = "Atlantis",
                                       name = c("Atlas", "II", "Poseidon", "I", "a", "b", "c", "d", "Zeus", "Thanos", "a1", "a2"),
                                       start = c("-2500/-2000", -750, -1500, -1500, -400, -350, -150, 100, -200, -400, -1500, -1000),
                                       end = c(-1500, -200, -200, -750, -350, -250, 100, 300, 500, 300, -1000, -750),
                                       level = c(1, 2, 1, 2, 2, 2, 2, 2, 1, 1, 3, 3),
...
test_plot_err_level <- tibble::tibble(region = "Atlantis",
                                      name = c("Atlas", "II", "Poseidon", "I", "a", "b", "c", "d", "Zeus", "Thanos", "a1", "a2"),
                                      start = c("-2500/-2000", -750, -1500, -1500, -400, -350, -150, 100, -200, -400, -1500, -1000),
                                      end = c(-1500, -200, -200, -750, -350, -250, 100, 300, 500, 300, -1000, -750),
...
if (file.exists("Test_that.jpg")) {file.remove("Test_that.jpg")}
