...
#'
#' This function imports and converts chronological information saved in \code{.xls} or \code{.xslx} into a ready-to-plot data set. Missing values will be substituted by "!".
#'
#' @author Thomas Rose
#'
...
#'
#' This function imports and converts chronological information saved in \code{.csv} into a ready-to-plot data set. Missing values will be substituted by "!".
#'
#' @author Thomas Rose
#'
#' @param path the path of the file to be imported.
