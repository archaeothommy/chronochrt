...
#'
#' This is a theme for chronological charts to provide a ready-to-use layout of chronological charts. See Examples how to alter its appearance with \code{\link[ggplot2]themes)}.
#'
