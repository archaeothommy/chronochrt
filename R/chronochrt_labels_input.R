...
#' It is assumed that most of the labels will be located mostly on the right side of each column. The \code{position} of a label defines it right most end to prevent it from running outside the plotting area. Vertically, it will be placed centered on the \code{year} given. Text in labels can be wrapped by inserting \code{"\n"} (without blanks).
#'
