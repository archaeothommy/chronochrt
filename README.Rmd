...
ChronochRt is currently in the state of beta testing. You can install it from gitlab by: 
``` {r, include = FALSE}
...
Please help us to improve ChronochRt by filing observed bugs as an issue [here](mailto:incoming+roset-chronochrt-13993341-issue-@incoming.gitlab.com).
...
Is there a feature missing? Please let us know [here](mailto:incoming+roset-chronochrt-13993341-issue-@incoming.gitlab.com).
