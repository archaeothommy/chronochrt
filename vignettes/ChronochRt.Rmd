...
However, it is strongly recommended to use the geoms provided by ChronochRt for the compliation of more complex design (see chapter "ChronochRt for advanced R users"). 
...
However, some fine tuning is still required. By default, the axes are expanded. Additionally, the first example indicates, that the default facetting of ggplot2 is not optimal: 
