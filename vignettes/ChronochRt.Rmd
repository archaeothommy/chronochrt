...
London_labels <-add_label_text(region = "low socio-economic status",
               ...
               add_label_text(region = "urban",
                              year = c(1559, 1666),
                              label = c("1559: Coronation of Elizabeth I ", "1666: Great Fire of London"),
                              position = 1.98,
                              new =  FALSE) 
...
And the graph:
```{r Example_London_plot, echo=TRUE, fig.align='center', fig.width=10, fig.height=5, message=FALSE, out.width="100%"}
