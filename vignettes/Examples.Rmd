...
This vignette will demonstrate will provide some examples with chronological datasets compiled from the literature. They are included in the package and the first example shows how to load them. Alternatively, the datasets are available for download [here](https://gitlab.com/roset/chronochrt/tree/master/inst/extdata). 

### Examples 1: Chonological table
This example illustrates the main purpose of the package in the most basic way: facilitate the hasslefree drawing of chronological tables. 
