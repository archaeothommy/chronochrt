...
And that's it! Because a file name as well as physical dimensions were provided the chart is already saved as "UC-Chronology.png" in the working directory, with the specified size of 15x10 cm.
