...
This vignette demonstrates examples of chronological datasets which have been compiled from the literature. They are included in the package (see first example) or alternatively can be downloaded [here](https://gitlab.com/roset/chronochrt/tree/master/inst/extdata). 
...
And that's it! Because a file name as wekk as physical dimensions were provided the chart is already saved as "UC-Chronology.png" in the working directory, with the specified size of 15x10 cm.
